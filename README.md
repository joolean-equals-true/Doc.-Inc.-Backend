# Schedule Backend with Node

This application allows users to create and maintain a list of tutorials that can have multiple lessons within. Please visit https://github.com/OC-ComputerScience/schedule-frontend-vue2 for the Vue 2 frontend repository or https://github.com/OC-ComputerScience/schedule-frontend-vue3 for the Vue 3 frontend repository.
...
```
git clone https://github.com/OC-ComputerScience/schedule-backend.git
```
...
3. Configure **Apache** to point to **Node** for API requests.
   ...
   ```
   ProxyPass /schedule http://localhost:3100/schedule
   ```
...
4. Make a local **schedule** database.
